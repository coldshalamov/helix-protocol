...
def accept_mined_seed(
    ...
    *,
    ...
    if replace:
        ...
        event.setdefault("compression_improvements", []).append(
            {
                "original_miner": old_miner,
                "replacement_miner": miner,
                "original_seed_len": len(old_seed),
                "new_seed_len": len(seed),
                "depth_delta": old_depth - depth,
                "bonus_award": refund,
            }
        )
